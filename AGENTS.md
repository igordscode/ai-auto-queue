...
## Repository map
- `content.js/` — explain what lives here and when agents should edit it.
...
- `manifest.json/` — explain what lives here and when agents should edit it.
- `README.md/` — explain what lives here and when agents should edit it.
- `styles.css/` — explain what lives here and when agents should edit it.
